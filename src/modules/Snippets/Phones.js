    ...
    render() {
        ...
        return (
            <Card>
                ...
                <CardBody>
                    {!meta.error && (!fields || fields.length === 0) && <Intl str='nenhum-telefone-encontrado'></Intl>}    
                    ...
                    {fields.map((field, index) => {
                        return (
                            <Col key={index} xs={12} md={4}>
                                <Row>
                                    <Col xs={8} md={10}>
                                        <Phone name={`${field}.numero`} label={<Intl str='telefone'></Intl>} maxLength={15} required={this.props.required}/>
                                    </Col>
                                    <Col xs={4} md={2}>
