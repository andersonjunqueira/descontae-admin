    ...
    render() {
        ...
        return (
            <Form onSubmit={handleSubmit(doSubmit)}>
                <h4><Intl str='pesquisa-modeloss'></Intl></h4>
                <Row>
                    <Col xs={12} md={12}>
                ...
                <Modal isOpen={this.state.modal} toggle={toggle}>
                    ...
                    <ModalBody>
                        <Intl str="modelo-excluir-mensagem" params={[this.state.modalParam.nome]}></Intl>
                    </ModalBody>
                    <ModalFooter>
