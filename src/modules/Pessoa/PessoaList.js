    ...
    render() {
            ...
            content = (
                <div>
                    <Table hover size="sm" className="tabela">
                        <thead>
                            <tr>
                                <th className="table-w-10 text-center"><Intl str="tipo"></Intl></th>
                                <th className="table-w-50"><Intl str="nome"></Intl></th>
                                <th className="table-w-20 text-center"><Intl str="cpf"></Intl></th>
                                <th className="table-w-10"></th>
                            </tr>
                        </thead>
                        <tbody>
                            {Object.keys(data.content).map(function(key) {
                                let icon = "fa-user";
                                if(data.content[key].tipoPessoa.id === 1) {
                                    icon = "fa-bolt";
                                } else if(data.content[key].tipoPessoa.id === 2) {
                                    icon = "fa-hand-spock-o";
                                } else if(data.content[key].tipoPessoa.id === 3) {
                                    icon = "fa-building-o";
                                }
                                return (<tr key={key}>
                                    ...
                                    <td className="text-center">{cpfFunctions.applyMask(data.content[key].cpf)}</td>
                                    <td className="text-center">
        ...
        return (
            <Form onSubmit={handleSubmit(doSubmit)}>
                <h4><Intl str='pesquisa-pessoas'></Intl></h4>
                <Row>
                    <Col xs={12} md={12}>
                ...
                <Modal isOpen={this.state.modal} toggle={toggle}>
                    ...
                    <ModalBody>
                        <Intl str="pessoa-excluir-mensagem" params={[this.state.modalParam.nome]}></Intl>
                    </ModalBody>
                    <ModalFooter>
